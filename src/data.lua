	if settings.startup["wire-color"].value == "Invisible" then
    ...
    elseif settings.startup["wire-color"].value == "Visible 80%" then
    data.raw["utility-sprites"]["default"].
    copper_wire =
    {
    ...
    elseif settings.startup["wire-color"].value == "Visible 50%" then
    data.raw["utility-sprites"]["default"].
    copper_wire =
    {
	...
	wire_shadow =
    {
	 ...
	 elseif settings.startup["wire-color"].value == "Visible 30%" then
    data.raw["utility-sprites"]["default"].
    copper_wire =
    {
	...
	if settings.startup["wire-color-g"].value == "Invisible" then
	data.raw["utility-sprites"]["default"].
    green_wire =
    {
    ...
    elseif settings.startup["wire-color-g"].value == "Blue" then
...
data.raw["utility-sprites"]["default"].
  ...
  --      filename = "__AlmostInvisibleElectricWires__/graphics/green-wire-b.png",
   ...
   --   } 
	...
	elseif settings.startup["wire-color-g"].value == "Visible 50%" then
    data.raw["utility-sprites"]["default"].
    red_wire =
    {
	...
	if settings.startup["wire-color-r"].value == "Invisible" then
	data.raw["utility-sprites"]["default"].
    red_wire =
    {
    ...
    elseif settings.startup["wire-color-r"].value == "Yellow" then
	...
	elseif settings.startup["wire-color-r"].value == "Visible 50%" then
    data.raw["utility-sprites"]["default"].
    red_wire =
    {
